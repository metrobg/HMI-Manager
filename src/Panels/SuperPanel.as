...
package Panels { 
    ...
    public class SuperPanel extends Panel {
        ...
        [Bindable] public var exitFunction:Function = null;
        [Bindable] public var exitFunctionValue:String = null;
                
        [Embed(source="assets/icons/resizeCursor.png")]
...
//            this.setStyle("borderColor", 0xD2DCE2);
            ...
            if (showControls) {
	            if (enableResize) {
	                this.normalMaxButton.width         = 16;
	                this.normalMaxButton.height        = 16;
...
//                this.closeButton.styleName         = "closeBtn";
                this.closeButton.setStyle("upSkin",closeBtnImg);
                this.closeButton.setStyle("overSkin",closeBtnImg);
                this.closeButton.setStyle("downSkin",closeBtnImg);
                this.closeButton.setStyle("disabledSkin",closeBtnImg);
        ...
        public function positionChildren():void {
            if (showControls) {
                ...
                this.closeButton.x = this.unscaledWidth - this.closeButton.width - 4;
...
//                    child.setStyle("borderColor", 0x5A788A);
        ...
        {
//  Alert.show("Close Window ? \nWe can run all the functions we " + 
//  		"need now before actually closing the window", "Close Window intercepted\n" +
//	  		this.name, 3, this, alertClickHandler);
	  		if (exitFunction != null) 
	  		{
	  			exitFunction(exitFunctionValue);
	  		}
	  		else
	  		{
        ...
        private function alertClickHandler(event:CloseEvent):void {
	             if (event.detail==Alert.YES) {
	             	Application.application.removeItem(this.title);
